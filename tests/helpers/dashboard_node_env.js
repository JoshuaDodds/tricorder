...
function createWindowStub() {
  ...
  const defaultElementIds = [
    "toggle-all",
    "recording-count-recent",
    "recording-count-saved",
    "recording-count-recycle",
    "selected-count",
    "delete-selected",
    "download-selected",
    "rename-selected",
...
async function loadDashboard() {
  ...
  const header = [
    ...
    `  TRANSPORT_SKIP_FORWARD_SECONDS = 10,`,
    ...
    `  pathsDefaults = undefined,`,
    `  canonicalPathsSettings = undefined,`,
    `  canonicalPathsFromConfig = undefined,`,
    `  notificationsDefaults = undefined,`,
    `  canonicalNotificationsSettings = undefined,`,
    `  canonicalNotificationsFromConfig = undefined,`,
