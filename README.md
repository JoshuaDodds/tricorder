...
> The image is saved to `docs/images/staging-dashboard.png` for local reference and is not checked into git.
<sub>Last updated 2025-10-22T19:36:28+00:00 when the snapshot workflow completed.</sub>
