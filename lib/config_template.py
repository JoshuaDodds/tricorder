...
audio:
  ...
  # Number of input channels exposed by the capture device. Use 1 for mono USB mics,
  # 2 for stereo I²S hats (dual-mic arrays). Detection is run on a mono mixdown but
  # recordings and live streams preserve all channels.
  channels: 1
