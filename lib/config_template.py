...
audio:
  # ALSA device identifier. Use `arecord -l` to list devices or pick from the web UI dropdown.
  # Examples: "hw:1,0", "plughw:CARD=seeed2micvoicec,DEV=0"
  device: "default"

  # Number of input channels. 1 = mono, 2 = stereo.
  channels: 1

  # Some USB microphones require a reset when capture stalls. Disable for non-USB/I²S devices.
