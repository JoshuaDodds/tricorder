export function createArchivalSettingsController({
  ...
  function canonicalArchivalSettings(settings) {
    ...
    const canonical = {
      ...
      include_waveform_sidecars: defaults.include_waveform_sidecars,
      include_transcript_sidecars: defaults.include_transcript_sidecars,
      network_share: { target_dir: "" },
      rsync: {
        destination: "",
        ssh_identity: "",
    ...
    if (Object.prototype.hasOwnProperty.call(settings, "include_waveform_sidecars")) {
      canonical.include_waveform_sidecars = parseBoolean(
        settings.include_waveform_sidecars,
      );
    }
    if (Object.prototype.hasOwnProperty.call(settings, "include_transcript_sidecars")) {
      canonical.include_transcript_sidecars = parseBoolean(
        settings.include_transcript_sidecars,
      );
    }
  ...
  function applyData(settings, options = {}) {
    ...
    if (dom.archivalIncludeTranscripts) {
      dom.archivalIncludeTranscripts.checked = canonical.include_transcript_sidecars;
    }
  ...
  function readForm() {
    return {
      ...
      include_waveform_sidecars: dom.archivalIncludeWaveforms
        ...
        : false,
      include_transcript_sidecars: dom.archivalIncludeTranscripts
        ? dom.archivalIncludeTranscripts.checked
        : true,
      network_share: {
