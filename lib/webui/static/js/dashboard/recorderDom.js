  ...
  return {
    ...
    sections: {
      audio: {
        ...
        deviceSelect: documentRef.getElementById("audio-device-select"),
        deviceCustomWrapper: documentRef.getElementById("audio-device-custom-wrapper"),
        ...
        useUsbResetWorkaround: documentRef.getElementById("audio-usb-reset"),
