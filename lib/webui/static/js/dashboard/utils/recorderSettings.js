...
function canonicalAudioSettings(settings) {
  ...
  if (Object.prototype.hasOwnProperty.call(source, "use_usb_reset_workaround")) {
    defaults.use_usb_reset_workaround = parseBoolean(source.use_usb_reset_workaround);
  }
