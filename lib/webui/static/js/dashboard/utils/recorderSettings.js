...
function canonicalSegmenterSettings(settings) {
  ...
  if (Object.prototype.hasOwnProperty.call(source, "enable_motion")) {
    defaults.enable_motion = parseBoolean(source.enable_motion);
  }
  if (Object.prototype.hasOwnProperty.call(source, "enable_rms")) {
    defaults.enable_rms = parseBoolean(source.enable_rms);
  }
  if (Object.prototype.hasOwnProperty.call(source, "enable_vad")) {
    defaults.enable_vad = parseBoolean(source.enable_vad);
  }
