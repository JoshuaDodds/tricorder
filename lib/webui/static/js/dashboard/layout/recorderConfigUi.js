export function createRecorderConfigUi(deps) {
  ...
  function applySegmenterForm(data) {
    ...
    if (section.triggerMotion) {
      section.triggerMotion.checked = data.enable_motion;
    }
    if (section.triggerRms) {
      section.triggerRms.checked = data.enable_rms;
    }
    if (section.triggerVad) {
      section.triggerVad.checked = data.enable_vad;
    }
  }
  ...
  function readSegmenterForm() {
    ...
    if (section.triggerMotion) {
      payload.enable_motion = section.triggerMotion.checked;
    }
    if (section.triggerRms) {
      payload.enable_rms = section.triggerRms.checked;
    }
    if (section.triggerVad) {
      payload.enable_vad = section.triggerVad.checked;
    }
