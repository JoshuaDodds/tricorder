...
function setClipperVisible(visible) {
  if (!dom.clipperSection) {
    return;
  }
  dom.clipperSection.hidden = !visible;
  dom.clipperSection.dataset.active = visible ? "true" : "false";
  dom.clipperSection.setAttribute("aria-hidden", visible ? "false" : "true");
}
